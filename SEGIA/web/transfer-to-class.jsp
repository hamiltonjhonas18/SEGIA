...
<html lang="en">
    <head>
        ...
        <title>SEGIA - Transferir Aluno (Turma)</title>
                                    ...
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <li class="nav-item active">
                                            ...
                                            <ul class="nav nav-group-sub" data-submenu-title="Gestão">
                                                ...
                                                <li class="nav-item active"><a href="QWx1bm9TZXJ2bGV0I0RDSQ==?YWNjYW8jdHJhbnNmZXJpci10dXJtYQ==" class="nav-link"><i class="icon-flip-vertical4"></i> Transferir para Turma</a></li>
                                                    <%
                                                        }
                                                    %>
                                            </ul>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-flip-vertical4 position-left"></i> Transferir para Turma</a></li>
                            </ul>
                    ...
                    <div class = "row">
                        ...
                        <div class="col-md-6"> 
                            ...
                            <form method="post" accept-charset="ISO-8859-1" action="QWx1bm9TZXJ2bGV0I0RDSQ==?YWNjYW8jdHJhbnNmZXJpci10dXJtYQ==">
                        ...
                        <div class="col-md-6"> 
                            <!-- Basic layout-->
                            <%                                String act3 = encryptUtils.encodeString("accao#filtrar-turma&to=transfer-to-class");
                            %>
                                        ...
                                        <%
                                            if (inscricoes != null) {
                                                for (Inscricao i : inscricoes) {
                                                    ...
                                                    String s5 = encryptUtils.decodeString(a.getTurma().getTurmHorario());

                                                    String actA = encryptUtils.encodeString("accao#transferir-matricula-t&ei=" + id);
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <fieldset>
                                                                                        <legend class="text-semibold"><i class="icon-clipboard2 position-left"></i> Transferência para Turma</legend>
                                                                                                        ...
                                                                                                        <select data-placeholder="Selecione a turma" class="select" name="idTurma" required="">
                                                                                                            ...
                                                                                                            <%                                                                                                                if (turmas != null) {
                                                                                                                    for (Turma t : turmas) {
                                                                                                                        ...
                                                                                                                        String sel = "";
                                                                                                                        if (turma != null) {
                                                                                                                            if (t.getTurmId() != turma.getTurmId()) {
                                                                                                                                sel = "selected";
