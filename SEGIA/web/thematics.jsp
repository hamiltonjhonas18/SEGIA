...
<html lang="en">
    <head>
        ...
        <title>SEGIA - Planos Temáticos</title>
                                            ...
                                            <ul class="nav nav-group-sub" data-submenu-title="Planos Temáticos">
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li class="nav-item active"><a href="UGxhbm9zU2VydmxldCNEQ0k=?YWNjYW8jcGxhbm90ZW1hdGljbw==" class="nav-link"><i class="icon-clipboard3"></i> Visualizar Sumários</a></li>
                                                    </ul>
                                                </li>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-clipboard3 position-left"></i> Planos Temáticos</a></li>
                            </ul>
                    ...
                    <div class = "row">
                        ...
                        <div class="col-md-6"> 
                            ...
                            <form method="post" accept-charset="ISO-8859-1" action="UGxhbm9zU2VydmxldCNEQ0k=?YWNjYW8jcGxhbm90ZW1hdGljbw==">
                        ...
                        <div class = "col-md-8 col-md-offset-2">
                            ...
                            <div class="panel panel-flat">
                                ...
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="text-bold text-uppercase" rowspan=2"">#</th>
                                            <th class="text-bold text-uppercase" rowspan=2"">Temas</th>
                                            <th class="text-bold text-uppercase text-center" colspan="3">Horas</th>
                                        </tr>
                                        <tr>

                                            <th class="text-bold text-uppercase">Teóricas</th>
                                            <th class="text-bold text-uppercase">Práticas</th>
                                            <th class="text-bold text-uppercase">Total</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%
                                            ...
                                            if (temas != null) {
                                                ...
                                                for (Tema t : temas) {
                                                    ...
                                                    String s1 = encryptUtils.decodeString(t.getTemaDescricao());
                                                    String s2 = t.getTemaPratica() + "";
                                                    String s3 = t.getTemaTeorica() + "";
                                                    String s4 = (t.getTemaTeorica() + t.getTemaPratica()) + "";
