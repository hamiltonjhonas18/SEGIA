    ...
    <body onload="window.print();" oncontextmenu="return false">
        <table width="100%" border="0">
                    ...
                    <td scope="col" colspan="7">
                        ...
                        <table width="100%" id="customers">
                            ...
                            <tbody>
                                ...
                                %>
                                <tr>
                                    <td style="text-align:left;border-right:0.01em  solid #bababa; border-width:0.01em thin; max-width:150px; font-weight:bold;"><%=h%></td>
                                    ...
                                    <%
                                        ...
                                        for (String dis : aulas) {
                                            ...
                                            if (!dis.equals("")) {
                                    %>
                                    <td style="text-align:left;border-right:0.01em  solid #bababa; border-width:0.01em thin;display: table-cell;vertical-align: middle;max-width:150px;"><%=dis%></td>
                                    <%
                                    } else {
                                    %>

                                    <td style="text-align:center;border-right:0.01em  solid #bababa; border-width:0.01em thin;display: table-cell;vertical-align: middle;max-width:150px; font-weight:bold; font-size:14px;">-</td>
            ...
            <tfoot>
                ...
                <tr>
                    <td scope="col" colspan="7" style="height:20px;"></td>
                </tr>
                <tr>
