                            ...
                            <div class="sidebar-category sidebar-category-visible">
                                ...
                                <div class="category-content no-padding">
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <li class="nav-item active text-bold text-uppercase"><a href="Q3Vyc29TZXJ2bGV0I0RDSQ==?YWNjYW8jY3Vyc29zLWNlbnRybw=="><i class="icon-stack"></i> Classes por Escola</a></li>
                                    ...
                                    <div class="panel panel-flat">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label text-bold">Escola: </label>
                                            ...
                                            <div class="form-group hidden">
                                                <label class="col-lg-3 control-label text-bold">C.Inscrição: </label>
                                            ...
                                            <div class="form-group hidden">
                                                <label class="col-lg-3 control-label text-bold">Nº Prestações: </label>
