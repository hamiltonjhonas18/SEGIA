...
<html lang="en">
    <head>
        ...
        <%
            ...
            List<PInscricao> pinscricoes = null;
            ...
            if (usuario != null) {
                ...
                pinscricoes = (List<PInscricao>) session.getAttribute("pinscricoes");
                                    ...
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                %>
                                                <li class="active"><a href="UGFnYW1lbnRvU2VydmxldCNEQ0k=?YWNjYW8jcHJvcGluYXM="><i class="icon-cash4"></i> Pagamento Matriculas</a></li>
                                                    <%
                                                        }
                                                    %>
                ...
                <div class="content-wrapper">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                ...
                                <%
                                    ...
                                    if (turma != null) {
                                        tur = encryptUtils.decodeString(turma.getTurmDescricao()) + "|" + encryptUtils.decodeString(turma.getCurso().getCursDescricao()) + "|" + encryptUtils.decodeString(turma.getTurmHorario());
                                    }
                                %>

                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-cash4 position-left"></i> Pagamento de Propinas <span class="text-danger-600">(<%=tur%>)</span></a></li>
                            </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6"> 
                            ...
                            <form method="post" accept-charset="ISO-8859-1" action="UGFnYW1lbnRvU2VydmxldCNEQ0k=?YWNjYW8jcHJvcGluYXM=">
                                                ...
                                                <div class="row">
                                                                ...
                                                                <%
                                                                    if (turmas != null) {
                                                                        ...
                                                                        for (Turma t : turmas) {
                                                                            ...
                                                                            if (turma != null) {
                                                                                if (turma.getTurmId() == t.getTurmId()) {
                                                                                    sel = "selected";
                                                                                }
                                                                            }
                                                                %>
                                                    ...
                                                    <div class="col-md-3">
                                                        <button type="submit" onclick="this.disabled = 'disabled'; this.form.submit();" class="btn bg-grey-800 btn-labeled text-bold text-uppercase">
                                                            <b><i class="icon-chevron-left position-right"></i></b> 
                                                            Filtrar Turma
                                                        </button>
                        ...
                        <div class="col-md-6"> 
                            ...
                            <form method="post" accept-charset="ISO-8859-1" action="UGFnYW1lbnRvU2VydmxldCNEQ0k=?YWNjYW8jZmlsdHJhci1hbHVubw==">
                                <div class="panel panel-flat">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                                ...
                                                                <%
                                                                    if (inscricoes != null) {
                                                                        ...
                                                                        for (Inscricao i : inscricoes) {
                                                                            ...
                                                                            String desc = encryptUtils.decodeString(i.getAluno().getAlunBadgnumber()) + " - " + encryptUtils.decodeString(i.getAluno().getPessoa().getPessNome()) + " " + encryptUtils.decodeString(i.getAluno().getPessoa().getPessApelido());

                                                                            String sel = "";

                                                                            if (aluno != null) {
                                                                                if (aluno.getAlunId() == id) {
                                                                                    sel = "selected";
                                                                                }
                                                                            }
                                                                %>
                                                    ...
                                                    <div class="col-md-3">
                                                        <button type="submit" onclick="this.disabled = 'disabled'; this.form.submit();" class="btn bg-grey-800 btn-labeled text-bold text-uppercase">
                                                            <b><i class="icon-user position-right"></i></b> 
                                                            Filtrar Aluno
                                                        </button>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-flat">
                                <div class="panel-heading">
                                    <h6 class="panel-title text-uppercase text-bold text-bold text-uppercase">Lista dos pagamentos pendentes</h6>
                                    <div class="heading-elements">
                                        <ul class="icons-list">
                                ...
                                <%
                                    String act = encryptUtils.encodeString("accao#registar-pagamento");
                                %>
                                ...
                                <form class="form-horizontal"   method="post" accept-charset="ISO-8859-1" action="UGFnYW1lbnRvU2VydmxldCNEQ0k=?<%=act%>">
                                    ...
                                    <div class="panel-body">
                                        <a href="#"  data-toggle="modal" data-target="#modal_message" class="btn bg-danger-600 btn-labeled btn-lg text-bold text-uppercase">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h6 class="modal-title text-bold text-uppercase">Indique o Documento de Liquidação</h6>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="panel panel-flat">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="text-bold text-uppercase">Nº do Documento: </label>
                                                                    <div class="input-group col-md-12">
                                                                        <span class="input-group-addon"><i class="icon-file-text2"></i></span>
                                                                        <input type="text" class="form-control" placeholder="Nº Documento  ..." name="documento" required="">
                                                                    </div>
                                                                </div>


                                                                <div class="form-group">
                                                                    <label class="text-bold text-uppercase">Forma de Pagamento: </label>
                                                                    <div class="input-group col-md-8">


                                                                        <select data-placeholder="Selecione o Tipo de Pagamento" class="select" required="" name="formaPagamento" style=" width: 200px;">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="text-bold text-uppercase">Valor Pago: </label>
                                                                    <div class="input-group col-md-8">
                                                                        <span class="input-group-addon"><i class="icon-coins"></i></span>
                                                                        <input type="text" class="form-control" placeholder="Valor Pago  ..." name="valorPago" required="">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn bg-teal-800  text-bold text-uppercase">Confirmar Liquidação <i class="icon-coins"></i></button>
                                                            </div>
                                                        </div>
                                    ...
                                    <table class="table datatable-responsive">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-bold text-uppercase">D. Limite</th>
                                                <th class="text-bold text-uppercase text-danger-600">V. Multa</th>
                                                <th class="text-bold text-uppercase text-slate-800">V. Á Pagar</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <%
                                                    ...
                                                    for (PInscricao pi : pinscricoes) {
                                                        ...
                                                        if (p != null) {
                                                            if (!p.isPagStatus()) {
                                                                ...
                                                                String tur2 = encryptUtils.decodeString(p.getTurma().getTurmDescricao()) + "|" + encryptUtils.decodeString(p.getTurma().getCurso().getCursDescricao());

                                                                if (p.getPessoa() != null) {
                                                                    cli = encryptUtils.decodeString(p.getPessoa().getPessNome()) + " " + encryptUtils.decodeString(p.getPessoa().getPessApelido());
                                                                }
                                                                String ref = encryptUtils.decodeString(p.getPagReferencia());
                                                                ...
                                                                String bos = encryptUtils.decodeString(p.getInscricao().getAluno().getAlunBolseiro());

                                                                double vTotal = vMulta + p.getPagValor();
                                            %>
                                            <tr>
                                                ...
                                                <td class="text-italic"><%=tur2%></td>
                                                <td  class="text-danger-600"><%=prestacao%></td>
                                                <td><%=valorP%></td>
                                                <td><%=bos%></td>
                                                <td><span class="label <%=lblD%>"><%=dte + " á " + dteL%></span></td>
                                                <td  class="text-danger-600"><%=df.format(vMulta) + " - (" + multa + "%)"%></td>
                                                <td  class="text-slate-800 text-bold"><%=df.format(vTotal)%></td>
                                            </tr>
                                            <%
