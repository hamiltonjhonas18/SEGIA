...
<html>
    <head>
        ...
        <title>SEGIA - Resumo de Cursos</title>
    ...
    <body oncontextmenu="return false" onload="window.print();">
        <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <th scope="col" colspan="3">
                        <table width="100%">
                            ...
                            <tr>
                                <td style="font-weight:bold; font-size:12px;">RESUMO DOS CURSOS</td>
                            </tr>
                            <tr>
                    ...
                    <td scope="col" colspan="3">
                        ...
                        <table width="100%" class="customers">
                            ...
                            <thead>
                                ...
                                <tr>
                                    <td style="text-align:left;border-bottom:3pt solid #666; border-width:medium; text-transform:uppercase; font-weight:bold;">Descrição</td>
                                    <td style="text-align:left;border-bottom:5pt solid #666; border-width:medium; text-transform:uppercase; font-weight:bold;">Nº Inscrições</td>
                                    <td style="text-align:left;border-bottom:5pt solid #666; border-width:medium; text-transform:uppercase; font-weight:bold;">Grau de escolha</td>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <%
                                    if (rcursos != null) {
                                        ...
                                        for (RCursos rc : rcursos) {
                                            String desc = encryptUtils.decodeString(rc.getCurso().getCursDescricao());
                                            int num = rc.getNumInscricoes();
                                            String per = df.format(rc.getPercentagem());

                                %>
                                <tr>
                                    <td style="text-align:left;border-right:0.01em  solid #bababa; border-width:0.01em thin;display: table-cell;vertical-align: middle;"><%=desc%></td>
                                    <td style="text-align:left;border-right:0.01em  solid #bababa; border-width:0.01em thin; max-width:150px;"><%=num%></td>
                                    <td style="text-align:left;display: table-cell;vertical-align: middle; max-width: 150px;"><%=per%> %</td>
                                </tr>
                                <%
                                        }
                                    }
            ...
            <tfoot>
                ...
                <tr>
                    <td scope="col" colspan="3" style="height:40px;"></td>
                </tr>
                <tr>
                    <td  scope="col" colspan="3" ><hr style="font-weight:bold; height:3px; color:#000; background-color:#000;"></td>
                </tr>
