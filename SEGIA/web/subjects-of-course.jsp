...
<html lang="en">
    <head>
        ...
        <title>SEGIA - Disciplinas Classe</title>
        ...
        <%
            ...
            if (usuario != null) {
                ...
                if (disciplinasCurso != null) {
                    numRegistos = disciplinasCurso.size();
                }
                    ...
                    <div class="sidebar-category sidebar-category-visible">
                        ...
                        <div class="category-content no-padding">
                            <ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li class="nav-item text-bold text-uppercase active"><a href="RGlzY2lwbGluYVNlcnZsZXQjRENJ?YWNjYW8jZGlzY2lwbGluYXNDdXJzbw==" class="nav-link"><i class="icon-archive"></i> Disciplinas por Classe</a></li>
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-archive position-left"></i> Gestão de Disciplinas para as Classes </a></li>
                            </ul>
                        ...
                        <div class = "col-md-9 col-md-offset-1">
                            ...
                            <div class="content-group tab-content-bordered navbar-component">
                                <div class="navbar navbar-inverse bg-slate-800" style="position: relative; z-index: 99;">
                                    ...
                                    <%
                                        String lst = "";
                                        String act = encryptUtils.encodeString("accao#adicionar-disciplinas-curso");
                                ...
                                <div class="tab-content">
                                                        ...
                                                        <div class="col-md-9">
                                                            <fieldset>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-lg-4 control-label text-bold text-uppercase">Classe:</label>
                                                                    <div class="col-lg-8">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                    ...
                                    <div class="tab-pane fade has-padding" id="tab-demo2">
                                        ...
                                        <div class="panel panel-flat">
                                            <div class="panel-heading">
                                                <h6 class="panel-title text-bold text-uppercase">Listagem das disciplinas das classes</h6>
                                                <div class="heading-elements">
                                                    <ul class="icons-list">
                                                        <li><a data-action="collapse"></a></li>
                                                        <li><a data-action="reload"></a></li>
                                                ...
                                                <tbody>
                                                    <%
                                                        if (disciplinasCurso != null) {
                                                            ...
                                                            for (DisciplinaCurso dd : disciplinasCurso) {

                                                                int id = dd.getDisdId();

                                                                String s1 = encryptUtils.decodeString(dd.getDisciplina().getDiscDescricao());
                                                                String s2 = encryptUtils.decodeString(dd.getCurso().getCursDescricao());
