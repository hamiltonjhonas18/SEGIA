...
<html lang="en">
    <head>
        ...
        <title>SEGIA - Categorias de Formação</title>
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-pencil4 position-left"></i> Categorias de Formação</a></li>
                            </ul>
                    ...
                    <div class = "row">
                        ...
                        <div class = "col-md-12 col-md-offset-0">
                            ...
                            <div class="col-md-5">
                                ...
                                <!-- Basic layout-->
                                <%
                                    String act = encryptUtils.encodeString("accao#adicionar-categoria");
                                %>
                                <form method="post" accept-charset="ISO-8859-1" action="Q3Vyc29TZXJ2bGV0I0RDSQ==?<%=act%>" class="form-horizontal">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading">
                                            <h6 class="panel-title text-uppercase text-bold text-bold text-uppercase">Categoria de formação</h6>
                                            <div class="heading-elements">
                                                <ul class="icons-list">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-group col-md-10">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Descrição da categoria de formação ... " name="descricao" required="">
                                                        </div>
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h6 class="panel-title text-uppercase text-bold text-bold text-uppercase">Lista das categorias de formação</h6>
                                        <div class="heading-elements">
                                            <ul class="icons-list">
                                                <li><a data-action="collapse"></a></li>
                                                <li><a data-action="reload"></a></li>
                                            ...
                                            <%
                                                if (areas != null) {
                                                    for (Area af : areas) {
                                                        ...
                                                        int id = af.getAreaId();
                                                        String desc = encryptUtils.decodeString(af.getAreaDescricao());

                                                        String actR = encryptUtils.encodeString("accao#remover-categoria&id=" + id);
                                            %>
                                            <tr>
                                                <td><a href="#"><%=id%></a></td>
                                                <td><%=desc%></td>
