                ...
                <tr>
                    ...
                    <th scope="col" colspan="3">
                        <table width="100%">
                            ...
                            <tr>
                                <td style="font-weight:bold; font-size:12px;">LISTAGEM DAS TURMAS</td>
                            </tr>
                            <tr>
                        ...
                        <table width="100%" class="customers">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:left;border-bottom:5pt solid #666; border-width:medium; text-transform:uppercase; font-weight:bold;">Inscritos</td>
                                    ...
                                    <td style="text-align:left;border-bottom:5pt solid #666; border-width:medium; text-transform:uppercase; font-weight:bold;">E-Estado</td>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <%
                                    if (rturmas != null) {
                                        for (RTurmas rt : rturmas) {
                                            ...
                                            String cur = encryptUtils.decodeString(rt.getTurma().getCurso().getCursDescricao());
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:left;border-right:0.01em  solid #bababa; border-width:0.01em thin; max-width:150px;"><%=ref%></td>
                                    ...
                                    <td style="text-align:left;border-right:0.01em  solid #bababa; border-width:0.01em thin;display: table-cell;vertical-align: middle;"><%=dur%></td>
                                    <td style="text-align:left;border-right:0.01em  solid #bababa; border-width:0.01em thin;display: table-cell;vertical-align: middle;"><%=cur%></td>
