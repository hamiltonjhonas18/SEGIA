                                    ...
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <li class="nav-item active">
                                            ...
                                            <ul class="nav nav-group-sub" data-submenu-title="Gestão">
                                                ...
                                                <li class="nav-item active"><a href="QWx1bm9TZXJ2bGV0I0RDSQ==?YWNjYW8jYWx1bm9z" class="nav-link"><i class="icon-users2"></i> Listagem Alunos</a></li>
                                                <li>
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-library2 position-left"></i> Alunos Matriculados</a></li>
                            </ul>
                    ...
                    <div class = "row">
                        ...
                        <div class = "col-md-12 col-md-offset-0">
                            ...
                            <div class="panel panel-flat">
                                ...
                                <div class="panel-body">
                                    <p>
                                        <a href="QWx1bm9TZXJ2bGV0I0RDSQ==?YWNjYW8jaW1wcmltaXItYWx1bm9z" target="_blank" class="btn bg-slate-400 btn-labeled btn-lg text-bold text-uppercase">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="btn text-bold text-uppercase-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="QWx1bm9TZXJ2bGV0I0RDSQ==?<%=actF%>"><i class="icon-file-eye text-grey-800"></i> Visualizar a ficha</a></li>
                                                        <li class="divider"></li>
                                                        ...
                                                        %>
                                                        <li><a href="QWx1bm9TZXJ2bGV0I0RDSQ==?<%=actA%>"><i class="icon-check text-success"></i> Regularizar estudante</a></li>
                                                            <%
                                                                }
                                                            %>
                                                        <li><a href="QWx1bm9TZXJ2bGV0I0RDSQ==?<%=actS%>"><i class="icon-subtract text-default"></i> Suspender estudante</a></li>


                                                        <%
                                                            if (!status.equals("Bloqueado")) {
                                                        %>
                                                        <li><a href="QWx1bm9TZXJ2bGV0I0RDSQ==?<%=actB%>"><i class="icon-spam text-warning"></i> Bloquear estudante</a></li>
                                                            <%
                                                                    }
                                                                }
                                                            %>
                                                        <li class="divider"></li>
                                                            <%
                                                                if (usuario.getTipoUsuariotipu().getTipuDescricao().equals("Super Administrador")
                                                                        || usuario.getTipoUsuariotipu().getTipuDescricao().equals("Super Administrador") || usuario.getTipoUsuariotipu().getTipuDescricao().equals("Super Administrador")
                                                                        || usuario.getTipoUsuariotipu().getTipuDescricao().equals("Director Pedagogico")
                                                                        || usuario.getTipoUsuariotipu().getTipuDescricao().equals("Secretario")) {
                                                            %>
                                                        <li><a  href="QWx1bm9TZXJ2bGV0I0RDSQ==?<%=actE%>"><i class="icon-database-edit2 text-primary-800"></i> Editar registo</a></li>
                                                            <%
                                                                }
                                                            %>
                                                            <%
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h6 class="modal-title text-semibold">Confirma a remoção do estudante com a referência #<%=id%> ?</h6>
                                                                </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="QWx1bm9TZXJ2bGV0I0RDSQ==?<%=actR%>" class="btn text-bold text-uppercase btn-danger">Sim, confirmo !</a>
