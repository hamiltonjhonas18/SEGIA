<%-- 
    Document   : dc-user-confirm
    Created on : May 27, 2016, 6:26:01 AM
    Author     : HJC2K8
--%>
...
<html lang="en">
    <head>
        ...
        <meta http-equiv="refresh" content="1;VXN1YXJpb1NlcnZsZXQjRENJ?YWNjYW8jY29uZmlybWFjYW8=">
        <title>SEGIA - Confirmação</title>
            ...
            <div class="page-content">
                ...
                <div class="content-wrapper">
                    ...
                    <%if (usuario != null) {
                            ...
                            String fotoperfil = usuario.getUsuaFotoperfil();
                            ...
                            String email = encryptUtils.decodeString(usuario.getUsuaUsuario());
                    ...
                    <form action="index.html">
                        <div class="panel login-form">
                            ...
                            <div class="panel-body">
                                <h6 class="content-group text-center text-semibold no-margin-top"><%=nome%> <small class="display-block"><%=email%></small></h6>
