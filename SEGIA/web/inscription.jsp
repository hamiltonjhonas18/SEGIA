                                        ...
                                        <li class="nav-item active">
                                            ...
                                            <ul class="nav nav-group-sub" data-submenu-title="Gestão">
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li class="nav-item active"><a href="QWx1bm9TZXJ2bGV0I0RDSQ==?YWNjYW8jaW5zY3JldmVyLWFsdW5v" class="nav-link"><i class="icon-profile"></i> Matricular Aluno</a></li>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-lg-3 control-label text-bold">Aluno:</label>
                                                        <div class="col-lg-9">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="mb-15">
