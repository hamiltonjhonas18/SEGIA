<%-- 
    Document   : teachers-of-grade
    Created on : Feb 11, 2017, 7:30:25 PM
    Author     : HJC2K8
--%>

<%@page import="com.dciapps.webclient.Turma"%>
<%@page import="com.dciapps.webclient.DocenteTurma"%>
...
<html lang="en">
    <head>
        ...
        <title>SEGIA - Turmas Professors</title>
        ...
        <%
            ...
            List<DocenteTurma> docentesTurma = null;
            int numRegistos = 0;
            String msgErro = "";
            String alerta = "";
            ...
            if (usuario != null) {
                ...
                docentesTurma = (List<DocenteTurma>) session.getAttribute("docentesTurma");
                ...
                if (docentesTurma != null) {
                    numRegistos = docentesTurma.size();
                }
                                    ...
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            ...
                                            <ul class="nav nav-group-sub" data-submenu-title="Parametrização">
                                                ...
                                                <li class="nav-item active"><a href="RGlzY2lwbGluYVNlcnZsZXQjRENJ?YWNjYW8jZG9jZW50ZXNUdXJtYQ==" class="nav-link"><i class="icon-list3"></i> Turmas Professor</a></li>
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-list3 position-left"></i> Gestão dos Docentes para as turmas </a></li>
                            </ul>
                        ...
                        <div class = "col-md-9 col-md-offset-1">
                            ...
                            <div class="content-group tab-content-bordered navbar-component">
                                <div class="navbar navbar-inverse bg-slate-800" style="position: relative; z-index: 99;">
                                    ...
                                    <%
                                        String lst = "";
                                        String act = encryptUtils.encodeString("accao#adicionar-docentes-turma");
                                        String vlBtn = "Associar docentes";
                                            ...
                                            <div class="panel panel-flat">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <fieldset>
                                                                <legend class="text-bold text-uppercase"><i class="icon-link position-left"></i> Selecione os docentes à associar</legend>




                                                                <div class="form-group">
                                                                    <label class="col-lg-4 control-label text-bold text-uppercase">Turma:</label>
                                                                    <div class="col-lg-8">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-lg-4 control-label text-bold text-uppercase">Docentes:</label>
                                                                    <div class="col-lg-8">
                                                                        <div class="row">
                                                                            <div class="col-md-12">

                                                                                <select data-placeholder="Selecione o(s) docente(s)" multiple="multiple" class="select-access-multiple" name="descDocentes" required="">
                                                                                    <option></option>
                                                                                    <optgroup label="Selecione o(s) docente(s)">
                                                    ...
                                                    <%
                                                        if (docentesTurma != null) {
                                                            ...
                                                            for (DocenteTurma dt : docentesTurma) {
                                                                ...
                                                                String s1 = encryptUtils.decodeString(dt.getTurma().getTurmDescricao());
                                                                String s2 = encryptUtils.decodeString(dt.getDocente().getPessoa().getPessNome()) + " " + encryptUtils.decodeString(dt.getDocente().getPessoa().getPessApelido());

                                                                String actR = encryptUtils.encodeString("accao#remover-docente-turma&ci=" + id);
                                                    %>
                                                    <tr>
                                                        <td><a><%=id%></a></td>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            ...
                                                                            <h6 class="modal-title text-semibold">Confirma a remoção na turma do docente com a referência #<%=id%> ?</h6>
                                                                        </div>
