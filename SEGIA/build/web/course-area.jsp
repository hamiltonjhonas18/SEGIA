                            ...
                            <div class="sidebar-category sidebar-category-visible">
                                ...
                                <div class="category-content no-padding">
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <!-- Main -->
                                        <li class="navigation-header"><span>aMain</span> <i class="icon-menu" title="Main pages"></i></li>
                                        ...
                                        <li class="nav-item active text-bold text-uppercase"><a href="Q3Vyc29TZXJ2bGV0I0RDSQ==?YWNjYW8jYXJlYXM=" class="nav-link"><i class="icon-graduation2"></i> Categorias Ensino</a></li>
