...
<html lang="en">
    <head>
        ...
        <title>SEGIA - Alunos Vulneráveis</title>
        ...
        <%
            ...
            if (usuario != null) {
                ...
                alunos = (List<Aluno>) session.getAttribute("alunosNecessitados");
                                    ...
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            ...
                                            <ul class="nav nav-group-sub" data-submenu-title="Relatórios">
                                                ...
                                                <li class="nav-item active"><a href="RXNjb2xhU2VydmxldCNEQ0k=?YWNjYW8jYWx1bm9zLW5lY2Vzc2l0YWRvcw==" class="nav-link"><i class="icon-collaboration"></i> Alunos Vulneráveis</a></li>
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-collaboration position-left"></i> Alunos Vulneráveis</a></li>
                            </ul>
                        ...
                        <div class = "col-md-12 col-md-offset-0">
                            ...
                            <div class="panel panel-flat">
                                <div class="panel-heading">
                                    <h6 class="panel-title text-uppercase text-bold text-bold text-uppercase">Lista dos Alunos Vulneráveis</h6>
                                    <div class="heading-elements">
                                        <ul class="icons-list">
