<%-- 
    Document   : dc-error-404
    Created on : Jun 1, 2016, 7:53:14 AM
    Author     : HJC2K8
--%>
            ...
            <div class="page-content">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-fluid text-center">
                        <h1 class="error-title"><i class="icon-shield-notice text-danger-600" style="font-size:150px"></i></h1>
                        <h6 class="text-semibold content-group text-grey-800">Atenção ! Sessão não detectada.<br>Não foi detectada nenhuma sessão iniciada no seu navegador, queira por favor efectuar o login !</h6>
