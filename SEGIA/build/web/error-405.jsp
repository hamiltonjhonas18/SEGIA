            ...
            <div class="page-content">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-fluid text-center">
                        <h1 class="error-title"><i class="icon-wall text-warning-600" style="font-size:150px"></i></h1>
                        <h6 class="text-semibold content-group text-grey-800">A sua conta não tem permissão para aceder a este sistema !<br>Volte a página de login ou contacte-nos atráves do endereço <a href='mailto:support@dcinovaction.com'><strong>support@dcinovaction.com</strong></a><br><center>Obrigado!</center> </h6>
