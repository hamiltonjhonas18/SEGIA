    ...
    <head>
        ...
        <%
            ...
            if (usuario != null) {
                ...
                nacionalidade = (Nacionalidade) session.getAttribute("nacionalidade");
                ...
                if (nacionalidades != null) {
                    numRegistos = nacionalidades.size();
                }
                            ...
                            <div class="sidebar-category sidebar-category-visible">
                                ...
                                <div class="category-content no-padding">
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <li class="nav-item active text-bold text-uppercase"><a href="Q29uZmlndXJhY2FvU2VydmxldCNEQ0k=?YWNjYW8jbmFjaW9uYWxpZGFkZXM="><i class="icon-earth"></i> Nacionalidades</a></li>
                                    </ul>                        
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-earth position-left"></i> Gestão de Nacionalidades </a></li>
                            </ul>
                        ...
                        <div class = "col-md-9 col-md-offset-1">
                            ...
                            <div class="content-group tab-content-bordered navbar-component">
                                <div class="navbar navbar-inverse bg-slate-800" style="position: relative; z-index: 99;">
                                    ...
                                    <%
                                        String lst = "";
                                        String act = encryptUtils.encodeString("accao#registar-nacionalidade");
                                        ...
                                        if (nacionalidade != null) {
                                            lst = "hide";
                                            act = encryptUtils.encodeString("accao#confirma-editar-nacionalidade&pi=" + nacionalidade.getNaciId());
                                            vlBtn = "Actualizar Registo";
                                            lblReg = "Actualizar Registo";
                                            icnReg = "icon-pencil4";

                                            desc = encryptUtils.decodeString(nacionalidade.getNaciDescricao());
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade active in has-padding" id="tab-demo1">
                                        ...
                                        <!-- 2 columns form -->
                                        <form class="form-horizontal" id="form_reg"  method="post" accept-charset="ISO-8859-1" action="Q29uZmlndXJhY2FvU2VydmxldCNEQ0k=?<%=act%>">
                                            <div class="panel panel-flat">
                                                <div class="panel-heading">
                                                    <h6 class="panel-title text-bold text-uppercase">Informe os dados da nacionalidade</h6>
                                                    <div class="heading-elements">
                                                        <ul class="icons-list">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <fieldset>
                                                                <legend class="text-bold text-uppercase"><i class="icon-earth position-left"></i> Dados da nacionalidade</legend>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-8">
                                                                        <div class="row">
                                                                            <div class="col-md-8">
                                                                                <input type="text" placeholder="Descrição da nacionalidade" class="form-control" name="descricao" required="" value="<%=desc%>">
                                                                            </div>
                                                            ...
                                                            <div>
                                                                <%
                                                                    if (nacionalidade != null) {
                                                                        String actC = encryptUtils.encodeString("accao#cancelar-edicao-nacionalidade");
                                                                %>
                                                                <a href="Q29uZmlndXJhY2FvU2VydmxldCNEQ0k=?<%=actC%>" class="btn bg-danger-400 btn-labeled-left ml-10 text-uppercase text-bold"><i class="icon-cross2"></i> Cancelar edição</a>
                                                                <%
                                                                    }
                                                                %>
                                    ...
                                    <div class="tab-pane fade has-padding" id="tab-demo2">
                                        ...
                                        <div class="panel panel-flat">
                                            <div class="panel-heading">
                                                <h6 class="panel-title text-bold text-uppercase">Listagem das nacionalidades</h6>
                                                <div class="heading-elements">
                                                    <ul class="icons-list">
                                                        <li><a data-action="collapse"></a></li>
                                                        <li><a data-action="reload"></a></li>
                                            ...
                                            <div class="panel-body">
                                                <p>
                                                    <a href="Q29uZmlndXJhY2FvU2VydmxldCNEQ0k=?YWNjYW8jaW1wcmltaXItbmFjaW9uYWxpZGFkZXM=" target="_blank" class="btn bg-slate-400 btn-labeled btn-lg text-bold text-uppercase">
                                                        <b><i class="icon-printer2"></i></b>
                                                        Imprimir registos
                                                    </a>

                                                    <a href="#" class="btn bg-danger-300 btn-labeled btn-lg text-bold text-uppercase">
                                                    ...
                                                    <%
                                                        if (nacionalidades != null) {
                                                            ...
                                                            for (Nacionalidade n : nacionalidades) {
                                                                ...
                                                                String actE = encryptUtils.encodeString("accao#editar-nacionalidade&ci=" + id);
                                                                String actR = encryptUtils.encodeString("accao#remover-nacionalidade&ci=" + id);
                                                    %>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-right" style="width: 12em;
                                                                    ...
                                                                    <li><a href="Q29uZmlndXJhY2FvU2VydmxldCNEQ0k=?<%=actE%>"><i class="icon-database-edit2 text-blue-800"></i> Editar registo</a></li>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            ...
                                                                            <h6 class="modal-title text-semibold">Confirma a remoção da nacionalidade com a referência #<%=id%> ?</h6>
                                                                        </div>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="Q29uZmlndXJhY2FvU2VydmxldCNEQ0k=?<%=actR%>" class="btn btn-danger text-bold text-uppercase">Sim, confirmo !</a>
