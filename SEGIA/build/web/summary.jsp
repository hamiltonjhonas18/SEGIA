...
<%@page import="com.dciapps.webclient.Tema"%>
...
<html lang="en">
    <head>
        ...
        <title>SEGIA - Definir Plano</title>
        ...
        <%
            ...
            if (usuario != null) {
                ...
                temas = (List<Tema>) session.getAttribute("temas");
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            ...
                                            <ul class="nav nav-group-sub" data-submenu-title="Planos Temáticos">
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li class="nav-item active"><a href="UGxhbm9zU2VydmxldCNEQ0k=?YWNjYW8jcGxhbm9z" class="nav-link"><i class="icon-pencil6"></i> Definir Plano</a></li>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-pencil6 position-left"></i> Definição do Plano de Aulas </a></li>
                            </ul>
                    ...
                    <div class = "row">
                        ...
                        <div class="col-md-6"> 
                            ...
                            <form method="post" accept-charset="ISO-8859-1" action="UGxhbm9zU2VydmxldCNEQ0k=?YWNjYW8jcGxhbm9z">
                    ...
                    <div class = "row">
                        ...
                        <%
                            ...
                            String act = encryptUtils.encodeString("accao#registar-sumario");
                        %>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <!-- Basic layout-->
                            <form method="post" accept-charset="ISO-8859-1" action="UGxhbm9zU2VydmxldCNEQ0k=?<%=act%>" class="form-horizontal">

                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h6 class="panel-title text-bold text-uppercase">Definição do Plano de aulas <span class="text-danger-600">[<%=cur%> | <%=dis%>]</span></h6>
                                        <div class="heading-elements">
                                            <ul class="icons-list">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label class="text-bold text-bold">Tema: </label>

                                            <div class="col-lg-12">
                                                <div class="row">

                                                    <select data-placeholder="Selecione o tema" class="select" name="idTema" required="">
                                                        <optgroup label="Selecioneo tema">
                                                            <%
                                                                if (temas != null) {
                                                                    ...
                                                                    for (Tema t : temas) {
                                                                        ...
                                                                        int id = t.getTemaId();
                                                                        String desc = encryptUtils.decodeString(t.getTemaDescricao());
                                                            %>
                                        ...
                                        <div class="form-group">
                                            <label class="text-bold text-uppercase">Contéudo: </label>
                                            <div class="col-lg-12">
                                                <div class="row">

                                                    <div class="input-group col-md-12">
                                                        <span class="input-group-addon"><i class="icon-file-text"></i></span>
                                                        <input type="text" class="form-control" placeholder="Descrição do plano ... " name="descricao" required="">
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <label class="text-bold text-uppercase">Data Aula: </label>
                                            <div class="input-group col-md-5">
                                                <span class="input-group-addon"><i class="icon-calendar52"></i></span>
                                                <input type="text" class="form-control daterange-single" placehorlder="Data..." name="dataAula" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="text-bold text-uppercase">Objectivos:</label>
                                            <textarea rows="5" cols="5" class="form-control" placeholder="Descreva os objectivos ..." name="objectivo" required=""></textarea>
                                        </div>


                                        <div class="form-group">
                                            <label class="text-bold text-uppercase">Resumo do Conteúdo a ser trabalhado:</label>
                                            <textarea rows="5" cols="5" class="form-control" placeholder="Colocar em um breve resumo (1 linha) do que será abordado em sala (o tema da aula) ..." name="resumo" required=""></textarea>
                                        </div>


                                        <div class="form-group">
                                            <label class="text-bold text-uppercase">Metodologia:</label>
                                            <textarea rows="5" cols="5" class="form-control" placeholder="Descreva a metodologia ..." name="metodologia" required=""></textarea>
                                        </div>


                                        <div class="form-group">
                                            <label class="text-bold text-uppercase">Recursos Necessários:</label>
                                            <textarea rows="5" cols="5" class="form-control" placeholder="Descreva os recursos necessários ..." name="recursos" required=""></textarea>
                                        </div>


                                        <div class="form-group">
                                            <label class="text-bold text-uppercase">Avaliação:</label>
                                            <textarea rows="5" cols="5" class="form-control" placeholder="Descreva como serão avaliados os alunos ..." name="avaliacao" required=""></textarea>
                                        </div>


                                        <div class="form-group">
                                            <label class="text-bold text-uppercase">Bibliografia de Apoio:</label>
                                            <textarea rows="5" cols="5" class="form-control" placeholder="Descreva a bibliografia de apoio para o tema..." name="bibliografia" required=""></textarea>
                                        </div>
