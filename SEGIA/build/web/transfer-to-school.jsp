                                    ...
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <li class="nav-item active">
                                            ...
                                            <ul class="nav nav-group-sub" data-submenu-title="Gestão">
                                                ...
                                                <li class="nav-item active"><a href="QWx1bm9TZXJ2bGV0I0RDSQ==?YWNjYW8jdHJhbnNmZXJpci1lc2NvbGE=" class="nav-link"><i class="icon-transmission"></i> Transferir para Escola</a></li>
