            ...
            <div class="page-header-content">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                            ...
                            <button type="submit" onclick="this.disabled = 'disabled'; history.back();" class="btn text-bold text-uppercase btn-labeled btn-labeled-left bg-danger-400 heading-btn">Voltar a lista de registos<b><i class="icon-list3"></i></b></button>
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-calendar2 position-left"></i> Carga Horária do Professor</a></li>
                            </ul>
                        ...
                        <div class="col-md-6 col-md-offset-2">
                            ...
                            <div class="panel panel-flat">
                                <div class="panel-heading">
                                    <h6 class="panel-title text-uppercase text-bold text-bold text-uppercase">Carga Horária Do docente</h6>
                                    <div class="heading-elements">
                                        <ul class="icons-list">
                                ...
                                <div class="panel-body">
                                    <p>
                                        <a href="#" target="_blank" class="btn bg-slate-400 btn-labeled text-bold text-uppercase">
                                            ...
                                            Imprimir Mapa de Carga Horária
                                        </a>
                                    </p>
                                    ...
                                    <%
                                        ...
                                        if (docente != null) {
                                            s1 = encryptUtils.decodeString(docente.getPessoa().getPessNome()) + " " + encryptUtils.decodeString(docente.getPessoa().getPessApelido());
                                            s2 = encryptUtils.decodeString(docente.getDoceEspecialidade());
                                            s3 = encryptUtils.decodeString(docente.getDoceGrauFormacao());
                                        }
                                    %>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped">
                                            <tbody>
                                                <tr>
                                                    <td class="text-bold text-uppercase"><i class="icon-user"></i> Nome</td>
                                                    <td class="text-bold text-uppercase text-danger-600"><%=s1%></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-bold text-uppercase"><i class="icon-graduation2"></i> Grau de Formação</td>
                                                    <td><%=s3%></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-bold text-uppercase"><i class="icon-books"></i> Especialidade</td>
                                                    <td><%=s2%></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            if (disciplinasDocente != null) {
                                                for (DisciplinaDocente d : disciplinasDocente) {

                                                    int id = d.getDisdId();

                                                    String desc = encryptUtils.decodeString(d.getDisciplina().getDiscDescricao());
                                                    int carga = d.getDisciplina().getDiscCargaHoraria();
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-bold text-italic text-danger-600"><%=carga%> hrs.</td>
                                        </tr>
                                        <%
                                                }
                                            }
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2"><h6 class="text-bold">Total de Horas:</h6></td>
                                            <td><h6 class="text-bold text-italic text-danger-600"><%=tt%> hrs.</h6></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
