<%-- 
    Document   : dc-activaction-success
    Created on : May 27, 2016, 6:17:27 AM
    Author     : HJC2K8
--%>
...
<html lang="en">
    <head>
        ...
        <title>SEGIA - Activação com sucesso</title>
            ...
            <div class="page-content">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-fluid text-center">
                        <h1 class="error-title"><i class="icon-user-check text-success-600" style="font-size:150px"></i></h1>
                        <h6 class="text-semibold content-group text-grey-800"><strong>Activação com sucesso !</strong><br>Olá <%=nome%>, a activação da sua conta foi confirmada com sucesso.</h6>
