<%-- 
    Document   : dc-inefp-grades-schedule
                                    ...
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            ...
                                            <ul class="nav nav-group-sub" data-submenu-title="Parametrização">
                                                ...
                                                <li class="nav-item active"><a href="SG9yYXJpb1NlcnZsZXQjRENJ?YWNjYW8jaG9yYXJpb3M=" class="nav-link"><i class="icon-alarm"></i> Horários de Entrada</a></li>
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-alarm position-left"></i> Gestão de Horários de Entrada e Saída</a></li>
                            </ul>
                    ...
                    <div class = "row">
                        ...
                        <div class = "col-md-12 col-md-offset-0">
                            ...
                            <div class="col-md-5">
                                ...
                                <!-- Basic layout-->
                                <%
                                    String act = encryptUtils.encodeString("accao#adicionar-horario");
                                %>
                                <form method="post" accept-charset="ISO-8859-1" action="SG9yYXJpb1NlcnZsZXQjRENJ?<%=act%>" class="form-horizontal">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading">
                                            <h6 class="panel-title text-uppercase text-bold text-bold text-uppercase"><i class="icon-file-plus"></i> Novo Registo</h6>
                                            <div class="heading-elements">
                                                <ul class="icons-list">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label text-bold">Horário Inicio: </label>
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" id="anytime-time" name='hora_inicio' required="">
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label text-bold">Hora Fim: </label>
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-group col-md-6">
                                                            <span class="input-group-addon"><i class="icon-watch2"></i></span>
                                                            <input type="text" class="form-control" id="anytime-time-2"  name='hora_fim' required="">
                                                        </div>
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h6 class="panel-title text-uppercase text-bold text-bold text-uppercase">Lista dos horários</h6>
                                        <div class="heading-elements">
                                            <ul class="icons-list">
                                                <li><a data-action="collapse"></a></li>
                                                <li><a data-action="reload"></a></li>
                                            ...
                                            <%
                                                if (horarios != null) {
                                                    for (Horario h : horarios) {
                                                        ...
                                                        int id = h.getHoraId();
                                                        String hi = encryptUtils.decodeString(h.getHoraInicio());
                                                        String hf = encryptUtils.decodeString(h.getHoraFim());

                                                        String desc = hi + " - " + hf;

                                                        String actR = encryptUtils.encodeString("accao#remover-horario&id=" + id);
                                            %>
                                            <tr>
                                                <td><a href="#"><%=id%></a></td>
                                                <td><%=desc%></td>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="SG9yYXJpb1NlcnZsZXQjRENJ?<%=actR%>" class="btn text-bold text-uppercase btn-danger">Sim, confirmo !</a>
