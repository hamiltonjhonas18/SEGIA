                                    ...
                                    <ul class="navigation navigation-main navigation-accordion">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                %>
                                                <li class="active"><a href="UGFnYW1lbnRvU2VydmxldCNEQ0k=?YWNjYW8jb3V0cm9zLXBhZ2FtZW50b3M="><i class="icon-coins"></i> Outros Pagamentos</a></li>
                                                    <%
                                                        }
                                                    %>
                                                    <%
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-lg-3 control-label text-bold">Taxa:</label>
                                                        <div class="col-lg-7">
                                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-lg-3 control-label text-bold">F. Pagamento:</label>
                                                        <div class="col-lg-5">
                                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-lg-3 control-label text-bold">Nº Documento:</label>
                                                        <div class="col-lg-6">
